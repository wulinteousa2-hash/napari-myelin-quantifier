...
Version `1.4.1` adds study-level CSV/Excel analysis, filename-based sample IDs for blinded files such as `119.csv`, resumable imports from `calculated_*.xlsx`, direct two- or three-way comparison plots, sample-level statistics, PCA/k-means, and user-selected output folders.
